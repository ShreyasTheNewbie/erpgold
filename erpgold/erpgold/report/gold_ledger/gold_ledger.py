...
def get_columns(filters):
	columns = [
		...
		{"label": _("Purity"), "fieldname": "custom_purity", "width": 60},
  		{"label": _("Purity Percentage"), "fieldname": "custom_purity_percentage","fieldtype": "Percent", "width": 100},
		{
				"label": _("Serial No"),
				"fieldname": "serial_no",
				"fieldtype": "Link",
...
def get_item_details(items, sl_entries, include_uom):
	...
	query = (
		...
		.select(item.name, item.item_name, item.description, item.item_group, item.brand, item.stock_uom,item.custom_purity, item.custom_purity_percentage)
