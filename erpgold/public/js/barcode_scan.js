	...
	erpnext.utils.BarcodeScanner = Class.extend({
		...
		update_table(data) {
			return new Promise(resolve => {
				...
				const {item_code, barcode, batch_no, serial_no, uom, warehouse, custom_labour_type, custom_is_jewellery_item, custom_gold_value,custom_sales_labour_rate, custom_sales_labour_amount, custom_purity_percentage, custom_less_weight, custom_metal_type, custom_other_amount, custom_gross_weight, custom_fine_weight, custom_net_weight, custom_purity,custom_wastage,custom_is_mrp_item} = data;
				if(data.custom_is_jewellery_item==1){
				...
				let row = this.get_row_to_modify_on_scan(item_code, barcode, batch_no, serial_no, uom, warehouse, custom_labour_type, custom_is_jewellery_item, custom_gold_value,custom_sales_labour_rate, custom_sales_labour_amount, custom_purity_percentage, custom_less_weight, custom_metal_type, custom_other_amount, custom_gross_weight, custom_fine_weight, custom_net_weight, custom_purity,custom_wastage,custom_is_mrp_item);
				...
				frappe.run_serially([
					...
					() => this.set_item(row, item_code, barcode, batch_no, serial_no, uom, warehouse, custom_labour_type, custom_is_jewellery_item, custom_gold_value,custom_sales_labour_rate, custom_sales_labour_amount, custom_purity_percentage, custom_less_weight, custom_metal_type, custom_other_amount, custom_gross_weight, custom_fine_weight, custom_net_weight, custom_purity,custom_wastage,custom_is_mrp_item).then(qty => {
		...
		set_item(row, item_code, barcode, batch_no, serial_no, uom, warehouse, custom_labour_type, custom_is_jewellery_item, custom_gold_value,custom_sales_labour_rate, custom_sales_labour_amount, custom_purity_percentage, custom_less_weight, custom_metal_type, custom_other_amount, custom_gross_weight, custom_fine_weight, custom_net_weight, custom_purity,custom_wastage,custom_is_mrp_item) {
			return new Promise(resolve => {
...
// 		// this.custom_purity_percentage_field = opts.custom_purity_percentage_field || "custom_purity_percentage";
// 		// this.custom_is_jewellery_item_field = opts.custom_is_jewellery_item_field || "custom_is_jewellery_item";
// 		// this.custom_gross_weight_field = opts.custom_gross_weight_field || "custom_gross_weight";
// 		// this.custom_less_weight_field = opts.custom_less_weight_field || "custom_less_weight";
// 		// this.custom_net_weight_field = opts.custom_net_weight_field || "custom_net_weight";
// 		// this.custom_fine_weight_field = opts.custom_fine_weight_field || "custom_fine_weight";
// 		// this.custom_gold_rate_field = opts.custom_gold_rate_field || "custom_gold_rate";
// 		// this.custom_gold_value_field = opts.custom_gold_value_field || "custom_gold_value"
